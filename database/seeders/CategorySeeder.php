...
class CategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Seed Products (update category references)
        Product::create([
            'name' => 'Wit Brood',
            'categoriesid' => 4, // Bakkerij en banket
        ...
        Product::create([
            'name' => 'Rijst 1kg',
            'categoriesid' => 6, // Pasta, rijst en wereldkeuken
        ...
        Product::create([
            'name' => 'Bananen',
            'categoriesid' => 1, // Aardappelen, groente, fruit
        ...
        Product::create([
            'name' => 'Melk 1L',
            'categoriesid' => 3, // Zuivel, plantaardig en eieren
