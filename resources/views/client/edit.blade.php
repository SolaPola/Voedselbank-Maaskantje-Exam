                ...
                <div>
                    ...
                    <select id="preference" name="preference"
                        ...
                        <option value="Vegetarisch"
                            {{ old('preference', $client->preference) == 'Vegetarisch' ? 'selected' : '' }}>Vegetarisch
                        </option>
                        <option value="Veganistisch"
                            {{ old('preference', $client->preference) == 'Veganistisch' ? 'selected' : '' }}>
                            Veganistisch</option>
                        <option value="Halal"
                            {{ old('preference', $client->preference) == 'Halal' ? 'selected' : '' }}>Halal</option>
                        <option value="Glutenvrij"
                            {{ old('preference', $client->preference) == 'Glutenvrij' ? 'selected' : '' }}>Glutenvrij
                        </option>
                        <option value="Lactosevrij"
                            {{ old('preference', $client->preference) == 'Lactosevrij' ? 'selected' : '' }}>Lactosevrij
                        </option>
                        <option value="Diabetisch"
                            {{ old('preference', $client->preference) == 'Diabetisch' ? 'selected' : '' }}>Diabetisch
                        </option>
                    </select>
                    @error('preference')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" id="adults" name="adults"
                                value="{{ old('adults', $client->adults) }}" min="0" max="20" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green focus:border-transparent">
                            @error('adults')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" id="children" name="children"
                                value="{{ old('children', $client->children) }}" min="0" max="20"
                                required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green focus:border-transparent">
                            @error('children')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            <label for="babies" class="block text-sm font-medium text-gray-700 mb-2">Baby's
                                *</label>
                            <input type="number" id="babies" name="babies"
                                value="{{ old('babies', $client->babies) }}" min="0" max="10" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green focus:border-transparent">
                            @error('babies')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
