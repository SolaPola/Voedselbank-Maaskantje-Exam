...
<body class="bg-gray-100 min-h-screen">
    ...
    <script>
        function confirmDelete() {
            if (confirm('Weet je zeker dat je leverancier "{{ $supplier->name }}" wilt verwijderen? Deze actie kan niet ongedaan worden gemaakt.')) {
                document.querySelector('.delete-supplier-form').submit();
            }
        }
    </script>
</body>
