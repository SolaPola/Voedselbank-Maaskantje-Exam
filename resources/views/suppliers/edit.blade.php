...
<body class="bg-gray-100 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Leverancier Bewerken</p>
                </div>
    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h2 class="text-3xl font-bold text-gray-900">Leverancier Bewerken</h2>
            <p class="text-gray-600 mt-2">Werk de gegevens van {{ $supplier->name }} bij</p>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-auto pl-3">
                    <div class="-mx-1.5 -my-1.5">
                        <button type="button" onclick="document.getElementById('success-alert').remove()" class="inline-flex bg-green-100 rounded-md p-1.5 text-green-500 hover:bg-green-200 focus:outline-none">
        ...
        @if(session('error'))
        <div class="mb-6 bg-red-50 border-l-4 border-red-500 p-4 rounded-lg" role="alert" id="error-alert">
            <div class="flex">
                <div class="flex-shrink-0">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden border-t-4 border-orange">
            <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST" class="p-6" x-data="supplierForm()" @submit="validateForm">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_name" id="contact_name" value="{{ old('contact_name', $supplier->contact_name) }}" required
                    ...
                    <div>
                        ...
                        <input type="date" name="next_delivery" id="next_delivery" 
                            value="{{ old('next_delivery', $supplier->next_delivery ? date('Y-m-d', strtotime($supplier->next_delivery)) : '') }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="comment" id="comment" rows="3"
                            ...
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green focus:ring focus:ring-green focus:ring-opacity-50 @error('comment') border-red-500 @enderror">{{ old('comment', $supplier->comment) }}</textarea>
                        @error('comment')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
        ...
        function supplierForm() {
            return {
                form: {
                    ...
                    contact_name: '{{ old("contact_name", $supplier->contact_name) }}',
                    contact_email: '{{ old("contact_email", $supplier->contact_email) }}',
                    phone: '{{ old("phone", $supplier->phone) }}',
                    next_delivery: '{{ old("next_delivery", $supplier->next_delivery ? date("Y-m-d", strtotime($supplier->next_delivery)) : "") }}',
                    comment: '{{ old("comment", $supplier->comment) }}',
                },
                errors: {
                    name: '',
                    address: '',
